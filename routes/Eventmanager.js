...
routes.post("/create",protect,allowedUser([1,2,5,9]),checkEventStatus,createEventConfigRules,managerControl.createeventpkg)
        ...
        .get("/dashboard",protect,allowedUser([2,1,5,9]),checkEventStatus,managerControl.DashboardData)
        // .get("/bookings",protect,allowedUser([2,1,5,9]),checkEventStatus,managerControl.EventBookings)
